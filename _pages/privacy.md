...
Org Chart (“we” or “us” or “our”) respects the privacy of our users (“user” or “you”). This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our mobile application (the “Application”). We are committed to protecting your privacy and complying with the **General Data Protection Regulation (GDPR)** and other applicable data protection laws. Please read this Privacy Policy carefully. **IF YOU DO NOT AGREE WITH THE TERMS OF THIS PRIVACY POLICY, PLEASE DO NOT ACCESS OUR APPLICATIONS.**
...
### Information Collected and Stored by Org Chart
...
- **HubSpot Deal, Company, Contact, and Org Chart Information**:

  - Deal name
  - Company name
  - Contact names, email addresses, job titles, and associated company or deal relationships
  - Reporting lines and buying roles configured in the org chart
  - Org chart names and update history

- **Usage Information**:
  - Last use dates of Org Chart
...
- **HubSpot Records Used to Generate Org Chart Drafts**:
  - Associated contacts
  - Job titles and company information
  - Deal and company context needed to suggest reporting lines or buying roles

## Use of AI Services

Our app integrates services powered by multiple third-party artificial intelligence (AI) providers, including **OpenAI (via the OpenAI API or Azure OpenAI Service), Google Gemini, Anthropic Claude, and Meta Llama (via Groq)**. These services enable dynamic interactions and content generation to assist users in building and managing HubSpot org charts. By using our app, you acknowledge and agree to the following:
...
We (**Org Chart**) are the Data Controller.
...
**B. HubSpot CRM and Org Chart Data**

- Deal names, company names, contact names, contact roles, reporting lines, and org chart metadata  
...
- HubSpot contact, company, and deal context used for AI-generated org chart drafts
