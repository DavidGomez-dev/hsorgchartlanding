...
<ul>
  <li><strong>Contact list:</strong> shows HubSpot contacts and manual contacts available for the company, with the contact title under the name and compact relevance and engagement scores.</li>
  <li><strong>Chart preview:</strong> shows the current reporting structure and buying roles. Optional switches can add relevance and engagement visual cues to the boxes while you are reviewing the chart.</li>
</ul>
...
<p>Click a contact box in the chart to open the contact sidebar. The sidebar shows the contact name, title, HubSpot contact link when available, intelligence badges, buying roles, associated deals, email, phone, last contacted date, contact owner, lead status, lifecycle stage, and whether the contact came from HubSpot or was added manually.</p>

<p>The main editor controls are:</p>

<ul>
  <li><strong>Generate with AI:</strong> creates or updates a suggested chart from available company, deal, contact, buying-role, and engagement context.</li>
  <li><strong>Save:</strong> saves the chart, buying roles, reporting lines, and preview image. The button changes to <strong>Saved</strong> when there are no unsaved changes.</li>
  <li><strong>Edit / Done:</strong> turns visual organizing on or off. While editing, drag a contact onto another contact to set the reporting line.</li>
  ...
  <li><strong>Zoom controls:</strong> zoom out, zoom in, and fit the chart to the visible canvas.</li>
</ul>
...
<p class="text-center"><img src="/assets/images/guide161.png" alt="troubleshooting" class="mt-5 border border-3 border-primary rounded rounded-3"></p>
...
<p>Admins can enable or disable AI features and choose the AI provider used to generate org charts. The AI workflow uses available deal information, company context, contacts, buying roles, and engagement records.</p>
